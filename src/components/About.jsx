      ...
      <div className="aboutme">
        <Grid>
          <Row className="background">
            ...
            <p text="justify">I've several years of experience working in Food and Drug testing for NZ and multinational companies. I was always passionate about science and took great pride in my work but technology has always been my first love. It took a few years of soul searching but once I started learning how to code I knew it was what I wanted to do.</p>
          </Row>

          <Row className="background">
          <h1>What do I like about code?</h1>
          <p>I like the satisfaction that you get from creating something. There are so many new technologies emerging and I would love to be a part of something bigger which will shape people's lives. Although I like the server side stuff, I belive my real strength is in Design and Front end. I'm intersted in learning technologies such as AI, Augmented Reality, Data science and machine learning etc and to broaden my horizons.</p>
          </Row>
